...
class KeycloakAuthenticationTestCase(ModuleTestCase):
    authenticationTestFlows = [{"auth_keycloak_url": "http://localhost:18081/auth",
                                "auth_username": "admin",
                                "auth_password": "admin",
                                "realm": "master",
                                "alias": "Test create authentication flow copy",
                                "copyFrom": "first broker login",
                                "authenticationExecutions": [{"providerId": "identity-provider-redirector",
                                                              "requirement": "ALTERNATIVE",
                                                              "authenticationConfig": {"alias": "name",
                               ...
                               {"auth_keycloak_url": "http://localhost:18081/auth",
                                ...
                                "copyFrom": "first broker login",
                                "authenticationExecutions": [{"providerId": "idp-review-profile",
                                                              "requirement": "REQUIRED",
                                                              "authenticationConfig": {"alias": "New review profile config",
                                                                                       "config": {"update.profile.on.first.login": "on"}}},
                                                             ],
                                "state": "absent",
                                "force": False},
                               {"auth_keycloak_url": "http://localhost:18081/auth",
                               ...
                               {"auth_keycloak_url": "http://localhost:18081/auth",
                                ...
                                "authenticationExecutions": [{"providerId": "identity-provider-redirector",
                                                             ...
                                                             {"providerId": "auth-conditional-otp-form",
                                                              "requirement": "REQUIRED",
                                                              "authenticationConfig": {"alias": "test-conditional-otp",
                                                                                       "config": {"skipOtpRole": "admin",
    ...
    def test_create_authentication_flow_set_update_profile_on_first_login_to_on(
            self):
    ...
    def test_reorder_executions_in_existing_authentication_flow(self):
        ...
        for i, expectedExecution in enumerate(
                toModify["authenticationExecutions"], start=0):
            if expectedExecution["providerId"] != results.exception.args[0]["flow"]["authenticationExecutions"][i]["providerId"]:
                ...
                break
        self.assertTrue(
            executionsInSameOrder,
            "Execution have not been reordered")
